...
/* 
* Templete: Copy of Lucene BMBM25Similarity
*/
...
//	  private final float b  = (float)0.99;
	  private final float k1 = (float)1.15;
	  private final float b  = (float)0.85;
	   ...
	   */
//	  public MyPrivateBM25(float k1, float b) {
