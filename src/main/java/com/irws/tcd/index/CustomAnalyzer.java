...
public class CustomAnalyzer extends Analyzer{
	...
	protected TokenStreamComponents createComponents(String fieldName) {
		...
		tokenFilter = new TrimFilter(tokenFilter);

		//Remove stop words from text
		List<String> stopWordList = Arrays.asList("'ll","'tis","'twas","'ve","10","39","a","a's","able","ableabout","about",
		...
		tokenFilter = new SnowballFilter(tokenFilter, new EnglishStemmer());
